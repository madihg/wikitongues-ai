...
**Crúbadán is currently unreachable.** `crubadan.org` and `borel.slu.edu` both fail to connect from here (curl returns 000, not an HTTP error), independently confirmed by a second researcher on a different path. The 13,876-word figure comes from the OLAC record, not from the file. **Treat the size as unverified until someone retrieves the data.** Kevin Scannell is contactable and has historically shared Crúbadán data on request — worth one email.
...
| PanLex                                                                            | 3 Igala varieties: `igl-000` Igala, `igl-001` Igala-Oguluglu, `igl-002` Igala-Aladi                                                                                                                                                                                                          | 🟡 **CC BY-NC-SA 4.0** — _not_ CC0. Verified at https://panlex.org/license/: "Commercial use of these materials is permitted only by obtaining written permission from PanLex." **The NC clause is a real constraint for a model that may be served.** Expression counts unverified — `api.panlex.org` failed DNS |
...
**GRN's NC clause is the cheapest licence upgrade available in this whole audit.** GRN's Copyright Office explicitly offers permission beyond the default terms on request. Ask.
...
| Ejeba (2023), "Ígálâ Concord System", _JWAL_ 50 — https://journalofwestafricanlanguages.org                                                                                           | Free full text; **the entire JWAL archive is free**                                                                                                                                                                | CC BY-NC 4.0                           |
| Egbunu (2014), "Igala Proverbs as Bastions of Societal Harmony" — https://pdfs.semanticscholar.org/adcb/1bc83bff492c17fd204be0b97fdb258bee11.pdf                                      | ~5,600 words on Igala proverbs                                                                                                                                                                                     | **CC BY-NC 4.0 — cite, do not ingest** |
...
| Arokoyo (2020), phonology of Olùkùmi/Igala/Owé/Yorùbá, _Dialectologia_ 25                                                                                                             | Uses the Ibadan 400 Wordlist; gives 23 consonants                                                                                                                                                                  | CC BY-NC-ND 4.0                        |
...
| **A6** | Crúbadán Igala web crawl                  | ~13.9k words (unverified)         | 🟢 CC BY 4.0            | **Host unreachable**                | Email Kevin Scannell                                                                          |
...
| **A8** | **GRN "Words of Life" audio**             | 45 min 38 s speech                | 🟡 CC BY-NC-SA          | Trivial — MP3 zip                   | Take for research. **Ask GRN to waive NC** — cheapest licence upgrade available               |
...
| **X**  | PanLex                                    | unknown                           | 🟡 **CC BY-NC-SA**      | Medium                              | NC clause blocks commercial serving                                                           |
...
**12. PanLex** — https://panlex.org/license/ — written permission for commercial use, waiving the NC clause. Only worth the paperwork if we decide the lexical data matters.
